...
download_file('https://raw.githubusercontent.com/bandarr009/tgr/president/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |40٪       |') end
download_file('https://raw.githubusercontent.com/bandarr009/tgr/president/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |انتظر    |') end
download_file('https://raw.githubusercontent.com/bandarr009/tgr/president/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |انتظر  |') end
download_file('https://raw.githubusercontent.com/bandarr009/tgr/president/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'90% - |انتظر   |') end
download_file('https://raw.githubusercontent.com/bandarr009/tgr/president/games.lua','./plugins/games.lua')
