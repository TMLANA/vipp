...
if MsgText[1] == 'الالغاز' or MsgText[1] == 'لغز' then
  ...
  name = katu[math.random(#katu)]
  redis:set(boss..':Set_lgz:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(boss..':Fan_nan:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(boss..':alm_dol:'..msg.chat_id_,name)
...
return 'اول من يكتب ذي يفوز ⬅︎`'..(redis:get(boss..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب ذي يفوز ⬅︎    `'..(redis:get(boss..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(boss.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(boss.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(boss.."GAME:CHER"..msg.chat_id_,'نشيط') 
...
redis:set(boss.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
...
if msg.text == redis:get(boss..':Set_lgz:'..msg.chat_id_) then -- // لغز
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(boss..':Set_lgz:'..msg.chat_id_) then -- // الالغاز
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(boss..':Fan_nan:'..msg.chat_id_) then -- // اسماء فنانين
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(boss..':Fan_nan:'..msg.chat_id_) then -- // فنان
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(boss..':alm_dol:'..msg.chat_id_) then -- // علم الدوا
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(boss..':alm_dol:'..msg.chat_id_) then -- // دول
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(boss..':Set_Amthlh:'..msg.chat_id_) then -- // رياضيات
redis:incrby(boss..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(boss..':Set_Amthlh:'..msg.chat_id_)
