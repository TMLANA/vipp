...
if MsgText[1] == 'جمع' or MsgText[1] == 'مفرد' or MsgText[1] == 'جمع مفرد' then
katu = {'ضفدع','ابواب','جوال','بيت','ادراج','منزل','علب','شباك','عصير','عطور','عشره','صادق','مدارس','قلم','ممرضات','سيارة','اعلام','صياد','محلات','اسماء','شارع'};
name = katu[math.random(#katu)]
redis:set(amrko..':gma_v:'..msg.chat_id_,name)
name = string.gsub(name,'ضفدع','مفرد ضفادع')
name = string.gsub(name,'ابواب','جمع باب')
name = string.gsub(name,'جوال','مفرد جوالات؟')
name = string.gsub(name,'بيت','مفرد بيوت؟')
name = string.gsub(name,'ادراج','جمع درج؟')
name = string.gsub(name,'منزل','مفرد منازل؟')
name = string.gsub(name,'علب','جمع علبه؟')
name = string.gsub(name,'شباك','مفرد شبابيك؟')
name = string.gsub(name,'عصير','مفرد عصائر؟')
name = string.gsub(name,'عطور','جمع عطر؟')
name = string.gsub(name,'عشره','مفرد عشرات؟')
name = string.gsub(name,'صادق','مفرد صادقون؟')
name = string.gsub(name,'مدارس','جمع مدرسة؟')
name = string.gsub(name,'قلم','مفرد اقلام؟')
name = string.gsub(name,'ممرضات','جمع ممرضه؟')
name = string.gsub(name,'سيارة','مفرد سيارات؟')
name = string.gsub(name,'اعلام','جمع علم؟')
name = string.gsub(name,'صياد','مفرد صيادين؟')
name = string.gsub(name,'محلات','جمع محل؟')
name = string.gsub(name,'اسماء','جمع اسم؟')
name = string.gsub(name,'شارع','مفرد شوارع؟')
return '  اسرع واحد يحل ⏎ * '..name..' * ' 
end
...
if msg.text == redis:get(amrko..':gma_v:'..msg.chat_id_) then -- // جمع
redis:incrby(amrko..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(amrko..':gma_v:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك \n*   \n')
end

if msg.text == redis:get(amrko..':gma_v:'..msg.chat_id_) then -- // مفرد
redis:incrby(amrko..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(amrko..':gma_v:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك \n*   \n')
end

if msg.text == redis:get(amrko..':gma_v:'..msg.chat_id_) then -- // جمع مفرد
redis:incrby(amrko..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(amrko..':gma_v:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك \n*   \n')
end
