...
return "• الردود العامه مقفوله من قبل Dev  " 
...
𝐶ℎ𝑎 : [𝚂𝚘𝚞𝚛𝚌𝚎 𝚄𝚙𝚍𝚊𝚝𝚎𝚜](t.me/KBBBD)
𝙰𝚌𝚎 : [𝙰𝚌𝚎 𝚂𝚘𝚞𝚛𝚌𝚎](t.me/URRRP)
]]
end
...
if utf8.len(msg.text) > 350 then 
return sendMsg(msg.chat_id_,msg.id_,"• عذرا غير مسموح باضافه كلمه الرد باكثر من 350 حرف \n")
end
