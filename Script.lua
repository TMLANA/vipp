...
return '• اصدار سورس جاك : *v'..version..'* \n'
end
...
local inline = {{{text="قناه السورس : جاك ",url="t.me/KBBBD"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : جاك](t.me/KBBBD)',nil,inline,msg.id_)
return false
end
...
if not redis:get(amrko.."lock_leftgroup"..msg.chat_id_) then  return "• امر اطردني معطل من قبل اداره المجموعة  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,"•  لمنشئيين : ["..usersmnc.."] \n• هناك شخص قام بالتعديل"..uuseri.."\n• الاسم : ⇦「 "..NameUser.." 」 \n• الايدي : `"..msg.sender_user_id_.."`\n• رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n• نوع التعديل : "..Rwers.."\n" )   
