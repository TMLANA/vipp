...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل الردود المتعدده    \n• بواسطه ⇦"..NameUser.."  " ) 
...
if not msg.Creator then return "• هذا الامر يخص 〚 Myth,المنشئ 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل المنشن    \n• بواسطه ⇦"..NameUser.."  " ) 
...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل المنشن    \n• بواسطه ⇦"..NameUser.."  " ) 
else
redis:del(boss.."lock_takkl"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"• تم تعطيل المنشن بنجاح   \n• بواسطه ⇦"..NameUser.."  " ) 
end 
end,{msg=msg})
end 
...
if not msg.SuperCreator then return "• هذا الامر يخص  〚 المنشئ الاساسي,Myth 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Director  then return "• هذا الامر يخص 〚 المدير,المنشئ,Myth 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Admin then return "• هذا الامر يخص 〚 الادمن,المدير,المنشئ,Myth 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
...
if not msg.Creator   then return "• هذا الامر يخص 〚 المنشئ,Myth 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
redis:mset(
...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تفعيل تعيين الايدي Dev    \n• بواسطه ⇦"..NameUser.."  " )
else redis:set(boss.."lockidedit",true)
return sendMsg(msg.chat_id_,msg.id_,"• تم تفعيل تعيين الايدي Dev  بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل تعيين الايدي Dev    \n• بواسطه ⇦"..NameUser.."  " )
else
redis:del(boss.."lockidedit") 
return sendMsg(msg.chat_id_,msg.id_,"• تم تعطيل تعيين الايدي Dev  بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end 
end,{msg=msg})
end 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(boss.."lock_reda") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل ردود MY    \n• بواسطه ⇦"..NameUser.."  " )
else
redis:del(boss.."lock_reda")
return sendMsg(msg.chat_id_,msg.id_,"• تم قفل ردود MY بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(boss.."lock_reda") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح ردود MY    \n• بواسطه ⇦"..NameUser.."  " )
else 
redis:set(boss.."lock_reda",true)
return sendMsg(msg.chat_id_,msg.id_,"• تم فتح ردود MY بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(boss.."lock_has") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد قفل الاحصائيات    \n• بواسطه ⇦"..NameUser.."  " )
else
redis:del(boss.."lock_has")
return sendMsg(msg.chat_id_,msg.id_,"• تم قفل الاحصائيات بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end
end,{msg=msg})
end
function unlock_has(msg)
if not msg.SudoBase then return "• هذا الامر يخص Dev فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(boss.."lock_has") then
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح الاحصائيات    \n• بواسطه ⇦"..NameUser.."  " )
else 
redis:set(boss.."lock_has",true)
return sendMsg(msg.chat_id_,msg.id_,"• تم فتح الاحصائيات بنجاح   \n• بواسطه ⇦"..NameUser.."  " )
end
end,{msg=msg})
end
---------------Lock replay-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد فتح السب    \n• بواسطه ⇦"..NameUser.."  " ) 
else 
