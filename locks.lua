...
else redis:set(amrko.."lock_RandomRdod"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(amrko.."lock_RandomRdod"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل الردود المتعدده    \n• بواسطه ⇦"..NameUser.."  " ) 
else redis:del(amrko.."lock_RandomRdod"..msg.chat_id_) 
...
function unlock_asm(msg)
if not msg.Director then return "• هذا الامر يخص 〚 Myth,المنشئ,المدير 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(amrko.."lock_asm"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد كشف الاسم السورس    \n• بواسطه ⇦"..NameUser.."  " ) 
else redis:set(amrko.."lock_asm"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"• تم تفعيل كشف الاسم بنجاح   \n• بواسطه ⇦"..NameUser.."  " ) 
end 
end,{msg=msg})
end

function lock_asm(msg)
if not msg.Director then return "• هذا الامر يخص 〚 Myth,المنشئ,المدير 〛 فقط  " end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(amrko.."lock_asm"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"• تم بالتأكيد تعطيل  كشف الاسم    \n• بواسطه ⇦"..NameUser.."  " ) 
else redis:del(amrko.."lock_asm"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"• تم تعطيل كشف الاسم   \n• بواسطه ⇦"..NameUser.."  " ) 
end
end,{msg=msg})
end 
---------------Lock check -------------------
