...
name = katu[math.random(#katu)]
redis:set(ws..':Fan_nan:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':alm_dol:'..msg.chat_id_,name)
...
if msg.text == redis:get(ws..':Fan_nan:'..msg.chat_id_) then -- // اسماء فنانين
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(ws..':Fan_nan:'..msg.chat_id_) then -- // فنان
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(ws..':alm_dol:'..msg.chat_id_) then -- // علم الدوا
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(ws..':alm_dol:'..msg.chat_id_) then -- // دول
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end
