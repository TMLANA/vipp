...
msg.TheRankCmd = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'Dev 🎖' 
msg.TheRank = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'Dev 🎖️' 
msg.Rank = 1
elseif redis:sismember(boss..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(boss..":RtbaNew2:"..msg.chat_id_) or 'Myth '
msg.TheRank = redis:get(boss..":RtbaNew2:"..msg.chat_id_) or 'Myth '
msg.Rank = 2
elseif redis:sismember(boss..':MATH_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(boss..":RtbaNew9:"..msg.chat_id_) or 'Myth 🎖'
msg.TheRank = redis:get(boss..":RtbaNew9:"..msg.chat_id_) or 'Myth 🎖'
msg.Rank = 9
...
msg.TheRank = redis:get(boss..":RtbaNew5:"..msg.chat_id_) or 'مدير️' 
msg.Rank = 4
...
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(boss..':WELCOME_BOT'),[[• اهلا بك عزيزي انا بوت اسمي ]]..redis:get(boss..':NameBot:')..[[ .
...
if redis:get(boss..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
