...
if SUDO_USER == '' then
print('\n\27[1;31m￤ You Did not Enter USERID !\n￤ لم تقوم بادخال شي , يرجى الانتبا‏‏ وادخل الان ايدي المطور الاساسي')
create_config(Token)
end 
if not SUDO_USER:match('(%d+)(%d+)(%d+)(%d+)(%d+)') then
print('\n\27[1;31m￤ This is Not USERID !\n￤‏‏ذا الايدي ليس موجود بل تلكرام , عذرا ادخل الايدي الصحيح الان . ')
create_config(Token)
end 
print('('..SUDO_USER..')')
...
print('\n\27[1;31m￤ Conect is Failed !\n￤ حدث خطا في الاتصال بالسيرفر , يرجى مراسل‏‏ مطور السورس ليتمكن من حل المشكل‏‏ في اسرع وقت ممكن . !')
create_config(Token)
end
GetUser.result.username = GetUser.result.username or GetUser.result.first_name
print('\n\27[1;36m￤تم ادخال ايدي المطور بنجاح , سوف يتم تشغيل السورس الان .\n￤Success Save USERID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
ws = Token:match("(%d+)")
...
local Text = "• أهلاً بك عزيزي [Dev](tg://user?id="..SUDO_USER..") \n• شكراً لأستخدام سورس نابليون \n• أرسل /start\n• لأظهار اوامر المطور  المجهزه بالكيبورد\n\n."
...
if msg.sender_user_id_ == 1605449126 or msg.sender_user_id_ == 1605449126  then 
msg.TheRankCmd = 'Ace 🎖'
msg.TheRank = 'Ace 🎖'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew1:"..msg.chat_id_) or 'Dev 🎖' 
msg.TheRank = redis:get(amrko..":RtbaNew1:"..msg.chat_id_) or 'Dev 🎖️' 
msg.Rank = 1
elseif redis:sismember(amrko..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew2:"..msg.chat_id_) or 'Myth '
msg.TheRank = redis:get(amrko..":RtbaNew2:"..msg.chat_id_) or 'Myth '
msg.Rank = 2
elseif redis:sismember(amrko..':MATH_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew9:"..msg.chat_id_) or 'Myth 🎖'
msg.TheRank = redis:get(amrko..":RtbaNew9:"..msg.chat_id_) or 'Myth 🎖'
msg.Rank = 9
elseif msg.GroupActive and redis:sismember(amrko..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(amrko..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(amrko..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(amrko..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(amrko..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(amrko..":RtbaNew5:"..msg.chat_id_) or 'مدير️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(amrko..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(amrko..":RtbaNew6:"..msg.chat_id_) or 'ادمن'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(amrko..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(amrko..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 11 or msg.Rank == 9 then
msg.SuperCreator = true
msg.Creator = true
msg.Admin = true
msg.Director = true
end
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 9 then
msg.SudoUser = true
end
if msg.Rank == 1 or msg.Rank == 9  then
msg.MudoUser = true
end
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 9 then
msg.Creator = true
end
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 9 then
msg.Director = true
end
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 9 then
msg.Admin = true
end
if msg.Rank == 6 then
msg.Special = true
...
SUDO_USER = redis:hgetall(amrko..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(amrko..':WELCOME_BOT'),[[• اهلا بك عزيزي انا بوت اسمي ]]..redis:get(amrko..':NameBot:')..[[ .
• اختصاصي حماية المجموعات
• من السبام والتوجية والتكرار والخ...
• معرف Dev  : ]]..SUDO_USER:gsub([[\_]],'_')..[[ 
]])
return false
end
...
local inline = {{{text="• أضغط ۿنا للتأكد أنك لست ربوت ",callback_data="CheckRobotJoin:"..Senderid}}}
...
answerCallbackQuery(data.id_,"• تم فك التقييد بنجاح والتأكد بانك لست بوت ",true)
EditMsg(ChatID,dataid,"• تم فك التقييد بنجاح والتأكد بانك لست بوت ")
else
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1605449126 or msg.sender_user_id_ == 1605449126) then
return sendMsg(msg.chat_id_,msg.id_,"¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1605449126 or msg.sender_user_id_ == 1605449126) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1605449126 or msg.sender_user_id_ == 1605449126) then
...
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'*•* تم رفع النسخ‏‏ الاحتياطي\n*•* حاليا عدد مجموعاتك ‏‏ي‏‏ *'..redis:scard(amrko..'group:ids')..'* \n')
end
